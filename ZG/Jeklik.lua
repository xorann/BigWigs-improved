...
L:RegisterTranslations("enUS", function() return {
    ...
    --pull_trigger = "^grant me wings of vengance!",
    pull_trigger = "grant me wings of vengance!",
    
    fear_cmd = "fear",
    fear_name = "Fear",
    fear_desc = "Warn for Fear",
    fear_bartext = "Next Fear",
    ...
    charge_desc = "Warn for the charge",
    charge_bartext = "Charge",
...
function BigWigsJeklik:CHAT_MSG_MONSTER_YELL(msg)
	if string.find(msg, L["pull_trigger"]) then
        -- initial fear
        self:TriggerEvent("BigWigs_StartBar", self, L["fear_bartext"], 17, "Interface\\Icons\\Spell_Fire_SelfDestruct");
        
        -- initial charge
        self:TriggerEvent("BigWigs_StartBar", self, L["charge_bartext"], 24, "Interface\\Icons\\Spell_Fire_SelfDestruct");
        
        -- bats
        self:TriggerEvent("BigWigs_StartBar", self, L["swarm_bartext"], 68, "Interface\\Icons\\Spell_Fire_SelfDestruct");
        -- countdown
        self:ScheduleEvent("coundtdown5", "BigWigs_Message", 63, "", "Urgent", true, "Five")
        self:ScheduleEvent("coundtdown4", "BigWigs_Message", 64, "", "Urgent", true, "Four")
        self:ScheduleEvent("coundtdown3", "BigWigs_Message", 65, "", "Urgent", true, "Three")
        self:ScheduleEvent("coundtdown2", "BigWigs_Message", 66, "", "Urgent", true, "Two")
        self:ScheduleEvent("coundtdown1", "BigWigs_Message", 67, "", "Urgent", true, "One")
        self:ScheduleEvent("coundtdown0", "BigWigs_Message", 68, L["swarm_bartext"], "Urgent", true, "Alarm")
        
    elseif self.db.profile.bomb and string.find(msg, L["bomb_trigger"]) then
...
function BigWigsJeklik:CHAT_MSG_MONSTER_EMOTE(msg)
	...
	elseif self.db.profile.swarm and string.find(msg, L["swarm_trigger"]) then
        ...
        self:TriggerEvent("BigWigs_StartBar", self, L["swarm_bartext"], 60, "Interface\\Icons\\Spell_Fire_SelfDestruct");
	end
end
