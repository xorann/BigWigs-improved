...
L:RegisterTranslations("enUS", function() return {
    ...
    nextwhirlwind_cmd = "nextwhirlwind",
	nextwhirlwind_name = "Next (possible) Whirlwind Alert",
	nextwhirlwind_desc = "Warn for next (possible) Whirlwind",
    ...
    whirlwindoffbartext = "Next Whirlwind",
} end )
...
L:RegisterTranslations("deDE", function() return {
	...
	nextwhirlwind_name = "Naechster (moeglicher) Wirbelwind",
	nextwhirlwind_desc = "Warnung fuer den nachesten (moeglichen) Wirbelwind",
...
BigWigsSartura.toggleoptions = {"enrage", "whirlwind", "nextwhirlwind", "bosskill"}
...
function BigWigsSartura:BigWigs_RecvSync(sync)
    ...
    elseif sync == "SarturaWhirlwindOff" and self.db.profile.nextwhirlwind then
        self:TriggerEvent("BigWigs_StartBar", self, L["whirlwindoffbartext"], 15, "Interface\\Icons\\Ability_Warrior_InnerRage")
	end
end
...
function BigWigsSartura:CHAT_MSG_SPELL_PERIODIC_CREATURE_BUFFS(msg)
	...
	elseif msg == L"whirlwindoff" then
        self:TriggerEvent("BigWigs_SendSync", "SarturaWhirlwindOff")
    end
end
