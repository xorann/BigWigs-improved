...
function BigWigsChromaggus:BigWigs_RecvSync(sync, spellId)
	if sync == self:GetEngageSync() and spellId and spellId == boss and not started then
        ...
        self:ScheduleEvent("countdown2_1", "BigWigs_Message", 59, "", "Urgent", true, "One")  
    end
    ...
    self:ScheduleEvent("countdown_10"..spellName, "BigWigs_Message", 50, "", "Urgent", true, "Ten")
    self:ScheduleEvent("countdown_3"..spellName, "BigWigs_Message", 57, "", "Urgent", true, "Three")
    self:ScheduleEvent("countdown_2"..spellName, "BigWigs_Message", 58, "", "Urgent", true, "Two")
    self:ScheduleEvent("countdown_1"..spellName, "BigWigs_Message", 59, "", "Urgent", true, "One") 
end
