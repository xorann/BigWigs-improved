...
BigWigsBroodlord.toggleoptions = {"youms", "elsems", "msbar", "blast", "bosskill"}
...
function BigWigsBroodlord:MSEvent(msg)
    ...
    if string.find(msg, L["blast_trigger"]) and self.db.profile.blast then 
        self:TriggerEvent("BigWigs_StartBar", self, L["blast_bar"], 12, "Interface\\Icons\\Spell_Holy_Excorcism_02")
    end
end
