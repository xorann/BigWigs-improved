...
function BigWigsRagnaros:CHAT_MSG_MONSTER_YELL(msg)
	if (string.find(msg, L["trigger1"]) and self.db.profile.aoeknock) then
		...
		self:ScheduleEvent("bwragnarosaekbwarn", "BigWigs_Message", 25, L["warn2"], "Urgent")
		self:TriggerEvent("BigWigs_StartBar", self, L["bar1text"], 30, "Interface\\Icons\\Spell_Fire_SoulBurn")
